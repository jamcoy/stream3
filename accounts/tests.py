...
class CustomUserTest(TestCase):
    ...
    def test_registration_form_fails_wih_password1_missing(self):
        form = UserRegistrationForm({
            'public_name': 'Somebody',
            'email': 'test@test.com',
            'password2': 'letmein3',
    ...
    def test_registration_form_fails_wih_password2_missing(self):
        form = UserRegistrationForm({
            'public_name': 'Somebody',
            'email': 'test@test.com',
            'password1': 'letmein1',
    ...
    def test_registration_form_fails_wih_public_name_missing(self):
        form = UserRegistrationForm({
            'email': 'test@test.com',
            'password1': 'letmein1',
            'stripe_id': settings.STRIPE_SECRET,
